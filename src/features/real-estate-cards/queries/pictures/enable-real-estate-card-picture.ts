...
const enableRealEstateCardPicture = (data: IData) => apiClient.patch(
  `/real-estate-cards/${data.realEstateCardId}/pictures/${data.pictureId}/enable`,
  data
)


export const useEnableRealEstateCardPicture = () => {

  const client = useQueryClient()

  return useMutation(
    (data: IData) => enableRealEstateCardPicture(data).then(response => {
